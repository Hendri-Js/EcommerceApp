...
class PaymentService: NSObject {
    ...
    func startPayment(productsInCart: [ProductInCart], completion: @escaping PaymentCompletionHandler) {
        ...
        let total = PKPaymentSummaryItem(label: "合計", amount: NSDecimalNumber(value: totalPrice), type: .final)
        ...
        paymentRequest.merchantIdentifier = "merchant.com.hendrijs.ecommerceappdemo"
